/**
 * @file LaboratoryStandin.cpp
 *
 * @author Charles Owen
 *
 * Notice: This class may not be changed.
 */
 ...
 * Constructor
 */
LaboratoryStandin::LaboratoryStandin()
{
}
...
*/
void LaboratoryStandin::DrawLaboratory(std::shared_ptr<wxGraphicsContext> graphics)
{
    ...
    y = mY - LineSize * 3.5;
    CenteredString(graphics, L"Laboratory goes here!", mX, y, LineSize);
    y -= LineSpacing;

    {
        wstringstream str;
        str << L"Laboratory: " << mLaboratory << ends;
 ...
 */
void LaboratoryStandin::CenteredString(std::shared_ptr<wxGraphicsContext> graphics, const std::wstring &str, int x, int y, int dy)
{
    y -= dy;
